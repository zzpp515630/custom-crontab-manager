<template>
  ...
  >
    <div class="collapse-button flex-center" @click="isCollapse = !isCollapse">
      <i class="fold iconfont icon_fold"></i>
...
import { setAside } from "@/layout/util";
      ...
      handler() {
        let active =
          this.$route.meta && this.$route.meta.menu
            ...
            : this.$route.path;
        setAside(this.dynamicMenu, active);
      },
      deep: true,
      immediate: true,
    },
